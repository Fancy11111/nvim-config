...
M.jdtls = function()
  ...
  vim.keymap.set('n', '<leader>v', "<Cmd>lua require('jdtls').extract_variable()<CR>", { desc = 'Extract Variable', noremap = true, buffer = bufnr })
  vim.keymap.set('n', '<leader>c', "<Cmd>lua require('jdtls').extract_constant()<CR>", { desc = 'Extract Constant', noremap = true, buffer = bufnr })

  vim.keymap.set('n', '<leader>t', "<Cmd>lua require'jdtls'.test_nearest_method()<CR>", { desc = 'Test Method', noremap = true, buffer = bufnr })
  vim.keymap.set('n', '<leader>T', "<Cmd>lua require'jdtls'.test_class()<CR>", { desc = 'Test Class', noremap = true, buffer = bufnr })
  vim.keymap.set('n', '<leader>u', '<Cmd>JdtUpdateConfig<CR>', { desc = 'Update Config', noremap = true, buffer = bufnr })

  vim.keymap.set('v', '<leader>v', "<Esc><Cmd>lua require('jdtls').extract_variable(true)<CR>", { desc = 'Extract Variable', noremap = true, buffer = bufnr })
  vim.keymap.set('v', '<leader>c', "<Esc><Cmd>lua require('jdtls').extract_constant(true)<CR>", { desc = 'Extract Constant', noremap = true, buffer = bufnr })
  vim.keymap.set('v', '<leader>m', "<Esc><Cmd>lua require('jdtls').extract_method(true)<CR>", { desc = 'Extract Method', noremap = true, buffer = bufnr })
